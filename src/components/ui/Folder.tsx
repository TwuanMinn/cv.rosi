...
const Folder: React.FC<FolderProps> = ({ color = '#00513f', size = 1, items = [], className = '' }) => {
  const maxItems = 3;
  ...
  const paper1 = darkenColor('#f0fdf5', 0.1);
  const paper2 = darkenColor('#f0fdf5', 0.05);
  const paper3 = '#f0fdf5';
    ...
    <div style={scaleStyle} className={className}>
      ...
      >
        ...
        >
          ...
          <div
            className={`absolute z-30 w-full h-full origin-bottom transition-all duration-300 ease-in-out shadow-lg ${
